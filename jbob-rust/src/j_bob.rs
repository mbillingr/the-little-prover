...
pub fn set_arg_from<'a>(context: &'a Context<'a>, n: S<'a>, args: S<'a>, y: S<'a>, from: S<'a>) -> S<'a> {
if
atom(
context
,
...
pub fn is_induction_scheme_for<'a>(context: &'a Context<'a>, def: S<'a>, vars: S<'a>, e: S<'a>) -> S<'a> {
if
is_defun(
context
,
...
pub fn is_induction_scheme<'a>(context: &'a Context<'a>, defs: S<'a>, vars: S<'a>, e: S<'a>) -> S<'a> {
if
is_app(
context
,
...
pub fn is_def_contents<'a>(context: &'a Context<'a>, known_defs: S<'a>, formals: S<'a>, body: S<'a>) -> S<'a> {
if
is_formals(
context
,
...
pub fn totality_slash__lt<'a>(context: &'a Context<'a>, meas: S<'a>, formals: S<'a>, app: S<'a>) -> S<'a> {
app_c(
context
,
C__LT
...
pub fn totality_slash_meas<'a>(context: &'a Context<'a>, meas: S<'a>, formals: S<'a>, apps: S<'a>) -> S<'a> {
if
atom(
context
,
...
pub fn totality_slash_if<'a>(context: &'a Context<'a>, meas: S<'a>, f: S<'a>, formals: S<'a>, e: S<'a>) -> S<'a> {
if
is_if(
context
,
...
pub fn induction_slash_prems<'a>(context: &'a Context<'a>, vars: S<'a>, claim: S<'a>, apps: S<'a>) -> S<'a> {
if
atom(
context
,
...
pub fn induction_slash_if<'a>(context: &'a Context<'a>, vars: S<'a>, claim: S<'a>, f: S<'a>, e: S<'a>) -> S<'a> {
if
is_if(
context
,
...
pub fn induction_slash_defun<'a>(context: &'a Context<'a>, vars: S<'a>, claim: S<'a>, def: S<'a>) -> S<'a> {
induction_slash_if(
context
,
vars
...
pub fn induction_slash_claim<'a>(context: &'a Context<'a>, defs: S<'a>, seed: S<'a>, def: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn rewrite_focus_at_direction<'a>(context: &'a Context<'a>, dir: S<'a>, e1: S<'a>, e2: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn rewrite_focus_at_path<'a>(context: &'a Context<'a>, path: S<'a>, e1: S<'a>, e2: S<'a>) -> S<'a> {
if
atom(
context
,
...
pub fn equality_slash_equation<'a>(context: &'a Context<'a>, focus: S<'a>, concl_inst: S<'a>) -> S<'a> {
if
is_app_of_equal(
context
,
...
pub fn equality_slash_path<'a>(context: &'a Context<'a>, e: S<'a>, path: S<'a>, thm: S<'a>) -> S<'a> {
if
is_focus_is_at_path(
context
,
...
pub fn equality_slash_def<'a>(context: &'a Context<'a>, claim: S<'a>, path: S<'a>, app: S<'a>, def: S<'a>) -> S<'a> {
if
is_rator(
context
,
...
pub fn rewrite_slash_step<'a>(context: &'a Context<'a>, defs: S<'a>, claim: S<'a>, step: S<'a>) -> S<'a> {
equality_slash_def(
context
,
claim
...
pub fn rewrite_slash_continue<'a>(context: &'a Context<'a>, defs: S<'a>, steps: S<'a>, old: S<'a>, new: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn rewrite_slash_steps<'a>(context: &'a Context<'a>, defs: S<'a>, claim: S<'a>, steps: S<'a>) -> S<'a> {
if
atom(
context
,
...
pub fn rewrite_slash_prove<'a>(context: &'a Context<'a>, defs: S<'a>, def: S<'a>, seed: S<'a>, steps: S<'a>) -> S<'a> {
if
is_defun(
context
,
...
pub fn rewrite_slash_prove_plus_1<'a>(context: &'a Context<'a>, defs: S<'a>, pf: S<'a>, e: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn rewrite_slash_define<'a>(context: &'a Context<'a>, defs: S<'a>, def: S<'a>, seed: S<'a>, steps: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn rewrite_slash_define_plus_1<'a>(context: &'a Context<'a>, defs1: S<'a>, defs2: S<'a>, pfs: S<'a>) -> S<'a> {
if
equal(
context
,
...
pub fn j_bob_slash_step<'a>(context: &'a Context<'a>, defs: S<'a>, e: S<'a>, steps: S<'a>) -> S<'a> {
if
is_defs(
context
,
